  ...
  render() {
    ...
    return (
      <div>
          ...
          <div className="row">
            <div className="col-sm-4" style={{ height:"100%"}} >
              <div className="card categories" style={{ width:"300px" , marginRight:"-40px"}}onClick ={() => this.getShop(1)} >
                <img className="card-img-top" style={{  opacity: "0.8" }} src={shop} alt="Image" />
              ...
              {/* <div className="card" onClick ={() => this.getShop(1)} >
                <img className="card-img-top" style ={{height:  "200px" , width:  "200px" }} src={shop} alt="Image" />
            ...
            <div className="card categories" style={{ width:"300px" }}onClick={() => this.setState({ rendering: 3 })} >
                <img className="card-img-top" style={{ opacity: "0.8" }} src={add} alt="Image" />
              ...
              {/* <div className="card" onClick={() => this.setState({ rendering: 3 })}   >
                <img className="card-img-top" src={add} style={{ height: "200px", width: "200px" }} alt="Image" />
                <div className="card-body">
            ...
            <div className="card categories" style={{ width:"300px" , marginLeft:"-40px" }}  onClick={() => this.getProducts(2)} >
                <img className="card-img-top" style={{ opacity: "0.8" }} src={products} alt="Image" />
              ...
              {/* <div className="card" onClick={() => this.getProducts(2)} >
                <img className="card-img-top" src={products} style={{ height: "200px", width: "200px" }} alt="Image" />
                <div className="card-body">
                  <h1 className="card-text" style={header}>My Products</h1>
                </div>
              </div> */}
        ...
        {this.state.rendering === 1 && <Profile />}
